...
export const mitriceRichardsonCase: CaseFile = {
  ...
  exhibits: [
    {
      id: "portrait",
      src: `${IMG}/photo-mitrice.avif`,
      width: 1229,
      height: 1229,
      alt: "Studio portrait of Mitrice Richardson smiling, wearing a necklace, in front of a gray backdrop",
      kindLabel: "Photograph",
      title: "Mitrice Richardson",
      body: "<p>The portrait of Mitrice most widely shared during the search and in coverage of her case. She was 24, a psychology graduate of Cal State Fullerton, working and living in Los Angeles.</p>",
    },
    {
      id: "graduation",
      src: `${IMG}/photo-mitrice-headshot.avif`,
      width: 400,
      height: 345,
      alt: "Mitrice Richardson smiling outdoors, wearing a graduation stole",
      kindLabel: "Photograph",
      title: "Before the night",
      body: "<p>Mitrice outdoors in a graduation stole. Family and friends described her as bright and driven, with plans for a doctorate in psychology. Photos like this one anchored the family's flyers and press appearances through the eleven months she was missing.</p>",
    },
    {
      id: "receipt",
      src: `${IMG}/photo-receipt.avif`,
      width: 600,
      height: 963,
      alt: "Register receipt from Geoffrey's Malibu dated September 16, 2009, totaling $89.51, with an arrow pointing to the 7:40 pm timestamp",
      kindLabel: "Document",
      title: "The bill at Geoffrey's",
      dateLabel: "September 16, 2009 · 7:40 pm",
      tone: "sighting",
      body: "<p>The check from <a href=\"https://www.truecrimeresearchers.com/cases/mitrice-richardson\">Geoffrey's Malibu</a> on the evening of September 16: a cocktail, a Kobe steak, and valet, $89.51 in all. Mitrice was unable or unwilling to pay it, and the restaurant called the sheriff's department. The arrow marking the 7:40 pm timestamp is from the original research file.</p>",
    },
    {
      id: "vehicle-report",
      src: `${IMG}/photo-police-report.avif`,
      width: 1700,
      height: 2338,
      alt: "CHP 180 vehicle report for Mitrice Richardson's Honda Civic, with arrows pointing to the report and dispatch times",
      kindLabel: "Document",
      title: "The vehicle report",
      dateLabel: "September 16, 2009 · 9:50 pm",
      tone: "poi",
      body: "<p>The CHP 180 report for Mitrice's 1978 Honda Civic, towed from Geoffrey's at 27400 Pacific Coast Highway after her arrest. The remarks note the driver was arrested and the vehicle stored. When detectives searched the car a week later, her phone, her wallet, and a journal with erratic entries were inside it, 12 to 15 miles from the station that released her with none of them.</p>",
    },
    {
      id: "aerial",
      src: `${IMG}/photo-topography.avif`,
      width: 720,
      height: 498,
      alt: "Aerial view of rugged canyon terrain near Piuma Road in Malibu, with a marker deep in the brush",
      kindLabel: "Aerial",
      title: "The canyon",
      dateLabel: "August 9, 2010",
      tone: "remains",
      body: "<p>An aerial view of the terrain where park rangers found Mitrice's remains in August 2010, deep in the brush off Piuma Road. The homes near the road at the upper left sit within the radius earlier searches had covered. The marker is the general area given to the coroner and the family, not exact coordinates.</p>",
    },
  ],
