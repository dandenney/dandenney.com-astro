...
<img alt="Nic and The Captain from True Crime Garage" src="/tinkerings/true-crime-garage-map/true-crime-garage.jpg" width="2880" height="1800" />
...
Scroll down for the interactive map. Click a marker or an episode in the list to fly to its location and pull up details.
...
<section class="flex">
  ...
  checked>
  <label for="release" title="Sort by the episode's release date">Release</label>
  <input type="radio" id="event" name="sortType" value="event">
  <label for="event" title="Sort by the date of the case's earliest known event">Event</label>
  </div>
  </div>
...
<details>
<summary>Show all 28 skipped episodes</summary>
