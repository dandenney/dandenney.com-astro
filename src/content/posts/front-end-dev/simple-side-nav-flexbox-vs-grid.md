...
<img class="full-to-half-bleed" loading="lazy" src="/posts/front-end-dev/simple-side-nav-flexbox-vs-grid/sidebar.svg" alt="A sidebar nav layout that shifts to a different arrangement at tablet-range viewport sizes" />
