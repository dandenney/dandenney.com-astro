...
tags:
  - front-end-dev
socialImageFilename: og-losing-my-loyalty.jpg
thumb: "/posts/front-end-dev/losing-my-loyalty/losing-my-loyalty.webp"
thumbAlt: "A symbolic split-scene illustration showing the evolution of creative work. On the left: a designer/developer in the early 2000s deeply focused on mastering a single tool. Photoshop palettes, Dreamweaver windows, FTP apps, and thick manuals surround them in a cluttered office. On the right: the same person years later in a clean futuristic workspace orchestrating multiple AI agents through lightweight prompts and skill files. Instead of mastering one application, glowing “recipes” and workflow diagrams float between AI systems. The transition visually represents moving from software expertise to orchestration expertise. Detailed cinematic composition, realistic textures, thoughtful and slightly philosophical tone"
cloudinaryThumb: "posts/losing-my-loyalty.png"
---

I distinctly remember my first HTML editor: [CoffeeCup](https://en.wikipedia.org/wiki/CoffeeCup_HTML_Editor). It was the first thing that I used outside of the Windows text editor and I loved it. It took a very long time and a bunch of posts and screenshots from people using Dreamweaver to get me to switch from it. I've repeated that a few times with text editors, graphic design apps, FTP apps, and so on. I used Photoshop for web things for around 15 years and had some other long-running editor loyalty.
...
I also saw [this workflow](https://x.com/Saboo_Shubham_/status/2054988166541770782) that I may want to try, where I have Hermes orchestrating handoffs between Claude and Codex. 
...
With a lack of loyalty, you lose on growing expertise with a tool, but I think that's ok. There was a time where being expert-level with your editor or Photoshop was very important. I believe that time is mostly gone, at least for the work that I do. Orchestration feels like the new expertise that you want to grow and everything else is about both kinds of skills. Growing your personal skills with orchestrating multiple tools is one, but what I'm really talking about is creating skills for agents. At Nash AI Week recently, [Chris Thomas](https://www.linkedin.com/in/yndr/) shared a great quote. He prefaced it with an example of how his Nan knew how to make wonderful biscuits and the entire process was in her head. I'm paraphrasing, but it was something like: 
