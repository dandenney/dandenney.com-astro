...
[Every.to](https://every.to) started shipping articles with an "agent" toggle. If you flip it, the post turns into a clean markdown doc you can hand to an LLM. Most of my site is already markdown on disk, so this felt ripe to copy.
...
The one thing I didn't do (yet) is fully copy the approach that [Every.to](https://every.to) took. They summarize the content and provide some prompts at the end. That feels like a cool idea, but baby steps.