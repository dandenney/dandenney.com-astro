...
export const GET: APIRoute = async ({ request }) => {
  try {
    ...
    const type = (url.searchParams.get('type') as 'tracks' | 'artists') || 'tracks';
    const time_range = (url.searchParams.get('time_range') as 'short_term' | 'medium_term' | 'long_term') || 'short_term';
